...
//
//go:nosplit
func Handle(request types.OutgoingRequest, options cm.Option[types.RequestOptions]) (result cm.ErrResult[types.FutureIncomingResponse, types.ErrorCode]) {
...
//go:noescape
func wasmimport_Handle(request0 uint32, options0 uint32, options1 uint32, result *cm.ErrResult[types.FutureIncomingResponse, types.ErrorCode])
