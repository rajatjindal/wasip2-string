...
import (
	monotonicclock "github.com/rajatjindal/wasip2-string/internal/wasi/clocks/v0.2.0/monotonic-clock"
	ioerror "github.com/rajatjindal/wasip2-string/internal/wasi/io/v0.2.0/error"
	"github.com/rajatjindal/wasip2-string/internal/wasi/io/v0.2.0/poll"
...
//
//go:nosplit
func FieldsFromList(entries cm.List[cm.Tuple[FieldKey, FieldValue]]) (result cm.OKResult[Fields, HeaderError]) {
...
//go:noescape
func wasmimport_FieldsFromList(entries0 *cm.Tuple[FieldKey, FieldValue], entries1 uint32, result *cm.OKResult[Fields, HeaderError])
...
//
//go:nosplit
func (self Fields) Append(name FieldKey, value FieldValue) (result cm.ErrResult[struct{}, HeaderError]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_FieldsAppend(self0 uint32, name0 *uint8, name1 uint32, value0 *uint8, value1 uint32, result *cm.ErrResult[struct{}, HeaderError])
...
//
//go:nosplit
func (self Fields) Delete(name FieldKey) (result cm.ErrResult[struct{}, HeaderError]) {
	self0 := cm.Reinterpret[uint32](self)
	name0, name1 := cm.LowerString(name)
...
//go:noescape
func wasmimport_FieldsDelete(self0 uint32, name0 *uint8, name1 uint32, result *cm.ErrResult[struct{}, HeaderError])
...
//
//go:nosplit
func (self Fields) Set(name FieldKey, value cm.List[FieldValue]) (result cm.ErrResult[struct{}, HeaderError]) {
	self0 := cm.Reinterpret[uint32](self)
	name0, name1 := cm.LowerString(name)
	value0, value1 := cm.LowerList(value)
...
//go:noescape
func wasmimport_FieldsSet(self0 uint32, name0 *uint8, name1 uint32, value0 *FieldValue, value1 uint32, result *cm.ErrResult[struct{}, HeaderError])
...
//
//go:nosplit
func (self IncomingRequest) Consume() (result cm.OKResult[IncomingBody, struct{}]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_IncomingRequestConsume(self0 uint32, result *cm.OKResult[IncomingBody, struct{}])
...
//
//go:nosplit
func (self OutgoingRequest) Body() (result cm.OKResult[OutgoingBody, struct{}]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_OutgoingRequestBody(self0 uint32, result *cm.OKResult[OutgoingBody, struct{}])
...
//
//go:nosplit
func (self OutgoingRequest) SetAuthority(authority cm.Option[string]) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
	...
	result = cm.Reinterpret[cm.Result]((uint8)((uint32)(result0)))
	return
}
...
//
//go:nosplit
func (self OutgoingRequest) SetMethod(method Method) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self OutgoingRequest) SetPathWithQuery(pathWithQuery cm.Option[string]) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self OutgoingRequest) SetScheme(scheme cm.Option[Scheme]) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self RequestOptions) SetBetweenBytesTimeout(duration cm.Option[monotonicclock.Duration]) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self RequestOptions) SetConnectTimeout(duration cm.Option[monotonicclock.Duration]) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
	duration0, duration1 := lower_OptionDuration(duration)
...
//
//go:nosplit
func (self RequestOptions) SetFirstByteTimeout(duration cm.Option[monotonicclock.Duration]) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
	duration0, duration1 := lower_OptionDuration(duration)
...
//
//go:nosplit
func (self IncomingResponse) Consume() (result cm.OKResult[IncomingBody, struct{}]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_IncomingResponseConsume(self0 uint32, result *cm.OKResult[IncomingBody, struct{}])
...
//
//go:nosplit
func (self IncomingBody) Stream() (result cm.OKResult[streams.InputStream, struct{}]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_IncomingBodyStream(self0 uint32, result *cm.OKResult[streams.InputStream, struct{}])
...
//
//go:nosplit
func (self FutureTrailers) Get() (result cm.Option[cm.OKResult[cm.ErrResult[cm.Option[Fields], ErrorCode], struct{}]]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_FutureTrailersGet(self0 uint32, result *cm.Option[cm.OKResult[cm.ErrResult[cm.Option[Fields], ErrorCode], struct{}]])
...
//
//go:nosplit
func (self OutgoingResponse) Body() (result cm.OKResult[OutgoingBody, struct{}]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_OutgoingResponseBody(self0 uint32, result *cm.OKResult[OutgoingBody, struct{}])
...
//
//go:nosplit
func (self OutgoingResponse) SetStatusCode(statusCode StatusCode) (result cm.Result) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func OutgoingBodyFinish(this OutgoingBody, trailers cm.Option[Fields]) (result cm.ErrResult[struct{}, ErrorCode]) {
	this0 := cm.Reinterpret[uint32](this)
...
//go:noescape
func wasmimport_OutgoingBodyFinish(this0 uint32, trailers0 uint32, trailers1 uint32, result *cm.ErrResult[struct{}, ErrorCode])
...
//
//go:nosplit
func (self OutgoingBody) Write() (result cm.OKResult[streams.OutputStream, struct{}]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_OutgoingBodyWrite(self0 uint32, result *cm.OKResult[streams.OutputStream, struct{}])
...
//
//go:nosplit
func (self FutureIncomingResponse) Get() (result cm.Option[cm.OKResult[cm.ErrResult[IncomingResponse, ErrorCode], struct{}]]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_FutureIncomingResponseGet(self0 uint32, result *cm.Option[cm.OKResult[cm.ErrResult[IncomingResponse, ErrorCode], struct{}]])
