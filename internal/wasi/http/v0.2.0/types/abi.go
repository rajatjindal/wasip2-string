...
func lower_ResultOutgoingResponseErrorCode(v cm.ErrResult[OutgoingResponse, ErrorCode]) (f0 uint32, f1 uint32, f2 uint32, f3 uint64, f4 uint32, f5 uint32, f6 uint32, f7 uint32) {
	if v.IsOK() {
