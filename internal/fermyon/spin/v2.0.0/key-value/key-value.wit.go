...
//
//go:nosplit
func StoreOpen(label string) (result cm.ErrResult[Store, Error]) {
...
//go:noescape
func wasmimport_StoreOpen(label0 *uint8, label1 uint32, result *cm.ErrResult[Store, Error])
...
//
//go:nosplit
func (self Store) Delete(key string) (result cm.ErrResult[struct{}, Error]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_StoreDelete(self0 uint32, key0 *uint8, key1 uint32, result *cm.ErrResult[struct{}, Error])
...
//
//go:nosplit
func (self Store) Exists(key string) (result cm.ErrResult[bool, Error]) {
	self0 := cm.Reinterpret[uint32](self)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_StoreExists(self0 uint32, key0 *uint8, key1 uint32, result *cm.ErrResult[bool, Error])
...
//
//go:nosplit
func (self Store) Get(key string) (result cm.OKResult[cm.Option[cm.List[uint8]], Error]) {
	self0 := cm.Reinterpret[uint32](self)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_StoreGet(self0 uint32, key0 *uint8, key1 uint32, result *cm.OKResult[cm.Option[cm.List[uint8]], Error])
...
//
//go:nosplit
func (self Store) GetKeys() (result cm.ErrResult[cm.List[string], Error]) {
	self0 := cm.Reinterpret[uint32](self)
...
//go:noescape
func wasmimport_StoreGetKeys(self0 uint32, result *cm.ErrResult[cm.List[string], Error])
...
//
//go:nosplit
func (self Store) Set(key string, value cm.List[uint8]) (result cm.ErrResult[struct{}, Error]) {
	self0 := cm.Reinterpret[uint32](self)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_StoreSet(self0 uint32, key0 *uint8, key1 uint32, value0 *uint8, value1 uint32, result *cm.ErrResult[struct{}, Error])
