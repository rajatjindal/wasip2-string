...
import (
	redistypes "github.com/rajatjindal/wasip2-string/internal/fermyon/spin/redis-types"
...
//
//go:nosplit
func Publish(address string, channel string, payload redistypes.Payload) (result cm.ErrResult[struct{}, redistypes.Error]) {
...
//go:noescape
func wasmimport_Publish(address0 *uint8, address1 uint32, channel0 *uint8, channel1 uint32, payload0 *uint8, payload1 uint32, result *cm.ErrResult[struct{}, redistypes.Error])
...
//
//go:nosplit
func Get(address string, key string) (result cm.OKResult[redistypes.Payload, redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
...
//go:noescape
func wasmimport_Get(address0 *uint8, address1 uint32, key0 *uint8, key1 uint32, result *cm.OKResult[redistypes.Payload, redistypes.Error])
...
//
//go:nosplit
func Set(address string, key string, value redistypes.Payload) (result cm.ErrResult[struct{}, redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Set(address0 *uint8, address1 uint32, key0 *uint8, key1 uint32, value0 *uint8, value1 uint32, result *cm.ErrResult[struct{}, redistypes.Error])
...
//
//go:nosplit
func Incr(address string, key string) (result cm.OKResult[int64, redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Incr(address0 *uint8, address1 uint32, key0 *uint8, key1 uint32, result *cm.OKResult[int64, redistypes.Error])
...
//
//go:nosplit
func Del(address string, keys cm.List[string]) (result cm.OKResult[int64, redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
...
//go:noescape
func wasmimport_Del(address0 *uint8, address1 uint32, keys0 *string, keys1 uint32, result *cm.OKResult[int64, redistypes.Error])
...
//
//go:nosplit
func Sadd(address string, key string, values cm.List[string]) (result cm.OKResult[int64, redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Sadd(address0 *uint8, address1 uint32, key0 *uint8, key1 uint32, values0 *string, values1 uint32, result *cm.OKResult[int64, redistypes.Error])
...
//
//go:nosplit
func Smembers(address string, key string) (result cm.OKResult[cm.List[string], redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Smembers(address0 *uint8, address1 uint32, key0 *uint8, key1 uint32, result *cm.OKResult[cm.List[string], redistypes.Error])
...
//
//go:nosplit
func Srem(address string, key string, values cm.List[string]) (result cm.OKResult[int64, redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
	key0, key1 := cm.LowerString(key)
	values0, values1 := cm.LowerList(values)
...
//go:noescape
func wasmimport_Srem(address0 *uint8, address1 uint32, key0 *uint8, key1 uint32, values0 *string, values1 uint32, result *cm.OKResult[int64, redistypes.Error])
...
//
//go:nosplit
func Execute(address string, command string, arguments cm.List[redistypes.RedisParameter]) (result cm.OKResult[cm.List[redistypes.RedisResult], redistypes.Error]) {
	address0, address1 := cm.LowerString(address)
...
//go:noescape
func wasmimport_Execute(address0 *uint8, address1 uint32, command0 *uint8, command1 uint32, arguments0 *redistypes.RedisParameter, arguments1 uint32, result *cm.OKResult[cm.List[redistypes.RedisResult], redistypes.Error])
