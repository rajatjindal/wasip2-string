...
//
//go:nosplit
func Query(address string, statement string, params cm.List[rdbmstypes.ParameterValue]) (result cm.OKResult[rdbmstypes.RowSet, PgError]) {
...
//go:noescape
func wasmimport_Query(address0 *uint8, address1 uint32, statement0 *uint8, statement1 uint32, params0 *rdbmstypes.ParameterValue, params1 uint32, result *cm.OKResult[rdbmstypes.RowSet, PgError])
...
//
//go:nosplit
func Execute(address string, statement string, params cm.List[rdbmstypes.ParameterValue]) (result cm.ErrResult[uint64, PgError]) {
	address0, address1 := cm.LowerString(address)
	statement0, statement1 := cm.LowerString(statement)
	params0, params1 := cm.LowerList(params)
...
//go:noescape
func wasmimport_Execute(address0 *uint8, address1 uint32, statement0 *uint8, statement1 uint32, params0 *rdbmstypes.ParameterValue, params1 uint32, result *cm.ErrResult[uint64, PgError])
